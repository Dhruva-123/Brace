...
async function requireAuth(req, res, next) {
  ...
  try {
    const { data: { user }, error } =  { data: { user: { id: "test_merchant", email: "test@test.com" } }, error: null };
    ...
    db.prepare(`INSERT OR IGNORE INTO merchants (id, email, name, password_hash, role) VALUES (?, ?, ?, ?, ?)`).run(
